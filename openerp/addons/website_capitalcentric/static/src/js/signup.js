$(document).ready(function () 
{
    ...
    // {
    	...
    	// {
			...
			// openerp.jsonRpc("/website_capitalcentric/state_json/", 'call', {'country': 1})
			// .then(function (data) 
            // {	      
            // });
    ...
    {  
			...
			openerp.jsonRpc("/website_capitalcentric/state_json/", 'call', {'country': parseInt(countryname)})
            .then(function (data) 
            {	      
				if(data[0].length > 0)
				{          	          
    ...
    $("#contact_name").blur(function()
    {
     ...
     $("#venue_cemail").bind('blur', function() 
     {
     	...
     	if(confirm_email.length > 0)
     	{
	     	...
	     	{
	     		openerp.jsonRpc("/website_capitalcentric/check_email/", 'call', {'value': $(this).val(),'db_id' :''})
	     	 	.then(function(data)
	     	 	{	
	     	 		console.log(data);
	     	 		if(data == true)
	     	 		...
	     	 		{
	     	 			 $("#venue_cemail").css("border","1px solid #CCC");
	     	 			 $("#venue_email").css("border","1px solid #CCC");
	     	 		}
	     	 	});
	     	}
