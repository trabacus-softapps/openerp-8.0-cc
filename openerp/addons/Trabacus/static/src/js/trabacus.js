openerp.trabacus = function(openerp) 
{
    openerp.web_kanban.KanbanView.include({
        trabacus_display_members_names: function() {
            /*
        ...
        on_groups_started: function() {
            ...
            if (self.dataset.model === 'tr.prod.opt.flight') {
                self.trabacus_display_members_names();
            }
        },
    ...
    openerp.web_kanban.KanbanRecord.include({
        on_card_clicked: function() {
            if (this.view.dataset.model === 'tr.prod.opt.flight') {
                this.$('.oe_kanban_trabacus_list a').first().click();
            } else {
                this._super.apply(this, arguments);
            }
        },
